...
namespace 水電梯 {
     ...
     */
    //% block
    //% blockId=WaterElevator_build
    //% block="水電梯 基本型 高度 $height"
    //% height.defl=10
    //% height.min=3 height.max=300
     ...
     */
    //% block
    //% blockId=WaterElevator_buildX
    //% block="水電梯 大型 寬度 $width  高度 $height"
    //% width.defl=3
    //% width.min=1 height.max=20
    //% height.defl=10
    //% height.min=3 height.max=300
